...
def save_scan_to_csv(self, filename, store_conf=False):
    """
...
class ScanWindow(ScanWindowBase):
    ...
    def apply_properties(self):
        ...
        self.operator._set_duration_step(self.operator.properties['scan']['duration'])  # this optional line checks validity
